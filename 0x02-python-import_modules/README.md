# THIS IS 0x02-python-import_modules PROJECT UNDER THE REPOSITORY OF (alx-higher_level_programming)

We are to solve all mandatory and advance tasks correctly and make sure all files are turned into executable mode.
